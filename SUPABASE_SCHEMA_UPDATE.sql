-- Match My Sponsor - Add Missing Tables Only
-- Run this if you already have profiles table

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Events table (only if doesn't exist)
...
DROP POLICY IF EXISTS "Sponsors can create profile" ON sponsors;
...
DROP POLICY IF EXISTS "Match participants can view conversations" ON conversations;
...
DROP POLICY IF EXISTS "Match participants can view deliverables" ON deliverables;
DROP POLICY IF EXISTS "Match participants can update deliverables" ON deliverables;
