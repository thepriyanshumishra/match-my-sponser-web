  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div {...fadeInUp}>
        ...
        <p className="text-gray-600">Welcome back! Here's an overview of your events and activities.</p>
      </motion.div>
      ...
      <motion.div {...fadeInUp}>
        ...
        {events.length === 0 ? (
          <div className="text-center py-12 bg-white/20 backdrop-blur-md rounded-3xl border border-white/20">
            ...
            <p className="text-gray-600 mb-6">Create your first event to start finding sponsors</p>
            <button
              onClick={() => router.push('/organizer/create-event')}
